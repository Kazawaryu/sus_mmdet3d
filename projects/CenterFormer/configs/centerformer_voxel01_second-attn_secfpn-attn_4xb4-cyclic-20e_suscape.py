_base_ = ['../../../configs/_base_/datasets/suscape-3d.py',
...
tasks=[
            ...
            dict(num_class=2, class_names=['ScooterRider', 'BicycleRider']),
            dict(num_class=1, class_names=['Truck']),
            dict(num_class=2, class_names=['Van', 'Bus']),
            dict(num_class=3, class_names=['Scooter', 'Bicycle', 'Trimotorcycle']),
        ]
